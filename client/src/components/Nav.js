...
import {Navbar, Nav, NavItem, NavDropdown, DropdownButton, MenuItem, CollapsableNav} from "react-bootstrap";
...
class NavBarHeader extends Component {
	renderLinks(){
		if (this.props.authenticated){
			return <NavItem href="/signout">Log Out</NavItem>
		} else {
			return [
				<NavItem key={1} href="/signin">Login</NavItem>,
